  ...
  essays: [
    {
      ...
      body: [
        ...
        { p: "Primary food is physical, spiritual, emotional, financial, and environmental health. Secondary food is what we eat every day, and how that affects our wellbeing." },
        { p: "When primary food isn't being nourished, we have a tendency to turn to secondary food to find what we're looking for — and it usually doesn't address the root cause." },
        { h: "What shapes how we eat" },
        { list: [
          "Our personal beliefs and knowledge of food affect how we eat.",
          "Psychological and physiological factors shape how we look at food.",
          "Stress makes us eat out of emotion — and so does our lifestyle.",
          "Our environment changes how accessible food is, which in turn affects the nutrient value of our life.",
          "Our daily habits determine which foods we gravitate toward, and what feels safe.",
        ] },
        { h: "Moving away from food morality" },
        { p: "Self-awareness is essential. The more we gently crowd out the foods that aren't serving us, the easier it becomes to make better choices — without carrying guilt alongside them." },
      ],
    },
    {
      num: "No. 02",
